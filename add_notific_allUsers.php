        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_notific_allUsers.php">
                <p>Add All Users</p>
              </a>
              <div class="dropdown-divider"></div>
      ...
      <div class="content mt-4">
        <div class="container-fluid">
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_notification_all_users" value="<?php echo $id_notification_all_users; ?>">
            <div class="row mt-5 mb-2">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                <?php if($update==true): ?>
                  <h5 class="text-white font-weight-bold">Update notification to all users :</h5>
                <?php else: ?>
                  <h5 class="text-white font-weight-bold">Add new notification to all users :</h5>
                <?php endif; ?>
                <textarea name="notification_all_users" cols="30" rows="8" class="form-control" placeholder="Enter Notification ..."><?php echo htmlspecialchars($notification_all_users); ?></textarea>
                <div class="text-white"><?php echo $errors['notification_all_users'] ?></div>
              </div>
            </div>
            <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <?php if($update==true): ?>
                  <button name="update_notification_all_users" class="btn btn-primary">Update</button>
                <?php else: ?>
                  <button name="save_notification_all_users" class="btn btn-primary">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_notification_all_users" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
