      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./feedback.php">
                <p>View Feedback</p>
              </a>
        ...
        <div class="container-fluid">
            <div class="row d-block">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                <h3 class="text-white font-weight-bold">View Feedbacks :</h3>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
               <table class="table">
                ...
                <tbody>
                  ...
                  ?>
                  <tr>
                    <td><?php echo $row['id_user_feedback']; ?></td>
                    <td><?php echo $row['feedback']; ?></td>
                    <td>
                      <a href="./add_feedback.php?edit_feedback=<?php echo $row['ID_feedback']; ?>"><i class="material-icons">edit</i></a>
                      /
                      <a href="./add_feedback.php?delete_feedback=<?php echo $row['ID_feedback']; ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                <?php endwhile; ?>
                </tbody>
