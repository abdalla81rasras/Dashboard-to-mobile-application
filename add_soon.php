        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_soon.php">
                <p>Add Soon</p>
              </a>
            </div>
          </li>    
        ...
        <div class="container-fluid">
          <div class="row pb-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <?php if($update==true): ?>
                <h3 class="text-white font-weight-bold">Update Soon :</h3>
              <?php else: ?>
                <h3 class="text-white font-weight-bold">Add New Soon :</h3>
              <?php endif; ?>
            </div> 
          </div>
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="ID_Soon" value="<?php echo $ID_Soon; ?>">
            <div class="row mb-2">
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                <h5 class="text-white font-weight-bold">Title Soon :</h5>
                <input type="text" name="title_soon" class="form-control" placeholder="Enter Tile ..." value="<?php echo htmlspecialchars($title_soon); ?>">
                <div class="text-white"><?php echo $errors['title_soon'] ?></div>
              </div>
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5 ml-4">
                <h5 class="text-white font-weight-bold">Notification Soon :</h5>
                <input type="text" name="notification_soon" class="form-control" placeholder="Enter Notification ..." value="<?php echo htmlspecialchars($notification_soon); ?>">
                <div class="text-white"><?php echo $errors['notification_soon'] ?></div>
              </div>
            </div> <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <?php if($update==true): ?>
                  <button name="update_soon" class="btn btn-primary">Update</button>
                <?php else: ?>
                  <button name="save_soon" class="btn btn-primary">Save</button>
                <?php endif; ?>              
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_Soon" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
