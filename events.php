        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <div class="dropdown-divider"></div>
              <a class="nav-link dropdown-item active1" href="./events.php">
                <p>View Events</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Informations Events :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td><?php echo $row['user_id_events']; ?></td>
                  <td><?php echo $row['name_events']; ?></td>
                  <td><?php echo $row['events_ID']; ?></td>
                  <td>
                    <a href="./add_events.php?edit_events=<?php echo $row['ID_All_events']; ?>"><i class="material-icons">edit</i></a>
                    /
                    <a href="./add_events.php?delete_events=<?php echo $row['ID_All_events']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
              <?php endwhile; ?>
              </tbody>
