        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <div class="dropdown-divider"></div>
              <a class="nav-link dropdown-item active1" href="./CV_received.php">
                <p>CVs</p>
              </a>              
            </div>
          </li>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">view all Cover letter :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-10 col-xl-10">
              ...
              <tbody>
                ...
                <trz>
                  <td><?php echo $row['ID_CoverLetter'] ?></td>
                  <td><?php echo $row['Cover_Letter'] ?></td>
                  <td>
                    <a href="Uploded/<?php echo $row["Cover_Letter"]; ?>" download="<?php echo $row["Cover_Letter"]; ?>"><i class="material-icons">download</i></a> /
                    <a href="./add_jobs.php?delete_cvs=<?php echo $row['id_cvs']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
