      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./notific_allUsers.php">
                <p>View All Users</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Notifications All Users :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                <?php 
                    $select="SELECT * FROM `notification all users`";
                    $query=mysqli_query($conn , $select);
                    while($row=mysqli_fetch_assoc($query)):
                  ?>
                  <tr>
                    <td><?php echo $row['notification_all_users']; ?></td>
                    <td>
                      <a href="./add_notific_allUsers.php?edit_notification_all_users=<?php echo $row['id_notification_all_users']; ?>"><i class="material-icons">edit</i></a>
                      /
                      <a href="./add_notific_allUsers.php?delete_notification_all_users=<?php echo $row['id_notification_all_users']; ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
