      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./courses.php">
                <p>View Courses</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Informations Curses:</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <table class="table">
                ...
                <tbody>
                  <?php 
                    $select="SELECT * FROM `curses`";
                    $query=mysqli_query($conn , $select);
                    while($row=mysqli_fetch_assoc($query)):
                  ?>
                  <tr>
                    <td><?php echo $row['user_id_crouser']; ?></td>
                    <td><?php echo $row['name_courser']; ?></td>
                    <td><?php echo $row['Course_ID']; ?></td>
                    <td><?php echo $row['options']; ?></td>
                    <td>
                      <a href="./add_courses.php?edit_courses=<?php echo $row['user_id']; ?>"><i class="material-icons">edit</i></a>
                      /
                      <a href="./add_courses.php?delete_courses=<?php echo $row['user_id']; ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                  <?php endwhile; ?>
                </tbody>
