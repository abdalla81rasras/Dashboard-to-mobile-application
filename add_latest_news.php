        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_latest_news.php">
                <p>Add Latest News</p>
              </a>
            </div>
          </li>
        ...
        <div class="container-fluid">
          <div class="row pb-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <?php if($update==true): ?>
                <h3 class="text-white font-weight-bold">Update Latest News:</h3>
              <?php else: ?>
                <h3 class="text-white font-weight-bold">Add New Latest News:</h3>
              <?php endif; ?>
            </div> 
          </div>
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_latest_news" value="<?php echo $id_latest_news; ?>">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                <h5 class="text-white font-weight-bold">Title News:</h5>
                <input type="text" name="title_latest_news" value="<?php echo htmlspecialchars($title_latest_news); ?>" class="form-control" placeholder="Enter Title ...">
                <div class="text-white"><?php echo $errors['title_latest_news'] ?></div>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                <h5 class="text-white font-weight-bold">Description News:</h5>
                <textarea name="description_latest_news" cols="50" rows="10" class="form-control" placeholder="Enter Description ..."><?php echo htmlspecialchars($description_latest_news); ?></textarea>
                <div class="text-white"><?php echo $errors['description_latest_news'] ?></div>
              </div>
            </div>
            <div class="row mt-5 mb-2">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                <h5 class="text-white font-weight-bold">Upload Picture News:</h5>
                <input type="file" name="pic_latest_news" class="text-white" >
                <div class="text-white"><?php echo $errors['pic_latest_news'] ?></div> <br>
                <?php if($update==true): ?>
                  <p class="text-white font-weight-bold mr-2 d-inline">Old Picture :  </p>
                  <img src="Uploded/<?php echo $pic_latest_news ?>" alt="Picture" style="width:100px; height: 100px;">
                <?php endif; ?>
              </div>
            </div> <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <?php if($update==true): ?>
                    <button name="update_latest_news" class="btn btn-primary">Update</button>
                <?php else: ?>
                    <button name="save_latest_news" class="btn btn-primary">Save</button>
                <?php endif; ?>                
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_latest_news" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
