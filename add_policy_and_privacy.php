        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_policy_and_privacy.php">
      ...
      <div class="content mt-4">
        <div class="container-fluid">
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_policy_and_privacy" value="<?php echo $id_policy_and_privacy; ?>">
            <div class="row mt-5 mb-2">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                <?php if($update==true): ?>
                  <h5 class="text-white font-weight-bold">Update policy and privacy :</h5>
                <?php else: ?>
                  <h5 class="text-white font-weight-bold">Add policy and privacy :</h5>
                <?php endif; ?>
                <textarea name="policy_and_privacy" cols="30" rows="8" class="form-control" placeholder="Enter Texts ..."><?php echo htmlspecialchars($policy_and_privacy); ?></textarea>
                <div class="text-white"><?php echo $errors['policy_and_privacy'] ?></div>
              </div>
            </div>
            <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <?php if($update==true): ?>
                  <button name="update_policy_and_privacy" class="btn btn-primary">Update</button>
                <?php else: ?>
                  <button name="save_policy_and_privacy" class="btn btn-primary">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_policy_and_privacy" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
