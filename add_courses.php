        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_courses.php">
                <p>Add Course</p>
              </a>
              <div class="dropdown-divider"></div>
        ...
        <div class="container-fluid">
          <div class="row pb-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <?php if($update==true): ?>
                <h3 class="text-white font-weight-bold">Update Corsers :</h3>
              <?php else: ?>
                <h3 class="text-white font-weight-bold">Add Corsers :</h3>
              <?php endif; ?>
            </div> 
          </div>
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                ...
                <input type="text" name="user_id_crouser" class="form-control" value="<?php echo htmlspecialchars($user_id_crouser); ?>" placeholder="Enter User ID ...">
                <div class="text-white"><?php echo $errors['user_id_crouser'] ?></div>
              </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                  <h5 class="text-white font-weight-bold">Course Name :</h5>
                  <input type="text" name="name_courser" class="form-control" value="<?php echo htmlspecialchars($name_courser); ?>" placeholder="Enter Course Name ...">
                  <div class="text-white"><?php echo $errors['name_courser'] ?></div>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                  <h5 class="text-white font-weight-bold">Course ID :</h5>
                  <input type="text" name="Course_ID" class="form-control" value="<?php echo htmlspecialchars($Course_ID); ?>" placeholder="Enter Course ID ...">
                  <div class="text-white"><?php echo $errors['Course_ID'] ?></div>
                </div>
            </div>
            <div class="row mt-5 mb-2">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                <h5 class="text-white font-weight-bold">Payment States :</h5>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3">
                <div class="radio-inline">
                    <label class="text-white font-weight-bold">
                    <input type="radio" name="options" value="Online" <?php if ($options == 'Online') echo 'checked="checked"'; ?> onclick="showThirdOption()"> Online
                </label>
                </div>
              </div>
              <?php if($update==false): ?>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4 d-block">  
                <label class="text-white font-weight-bold">
                  <input type="radio" name="options" value="Cash" onclick="showThirdOption()"> Cash
                </label>
                <div id="third-option" style="display: none;" class="third_option">
                  <label class="text-white font-weight-bold mr-4">
                    <input type="radio" name="options" value="Registered" <?php if ($options == 'Registered') echo 'checked="checked"'; ?>> Registered
                  </label>
                  <label class="text-white font-weight-bold mr-4">
                    <input type="radio" name="options" value="Paid" <?php if ($options == 'Paid') echo 'checked="checked"'; ?>> Paid
                  </label>
                  <label class="text-white font-weight-bold">
                    <input type="radio" name="options" value="Canseled" <?php if ($options == 'Canseled') echo 'checked="checked"'; ?>> Canseled
                  </label>
                </div>
                ...
                <div id="third-option" class="third_option">
                  <label class="text-white font-weight-bold mr-4">
                    <input type="radio" name="options" value="Registered" <?php if ($options == 'Registered') echo 'checked="checked"'; ?>> Registered
                  </label>
                  <label class="text-white font-weight-bold mr-4">
                ...
                <?php endif; ?>
                <script src="./assets/js/javascript_redio.js"></script>
              </div>
            </div>
            <div class="text-white"><?php echo $errors['options'] ?></div>
            <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <?php if($update==true): ?>
                  <button name="update_curses" class="btn btn-primary">Update</button>
                <?php else: ?>
                  <button name="save_curses" class="btn btn-primary">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_curses" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
