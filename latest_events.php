      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./latest_events.php">
                <p>View Event</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">View Latest Events :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                <?php 
                  $select="SELECT * FROM `latest events`";
                  $query=mysqli_query($conn , $select);
                  while($row=mysqli_fetch_assoc($query)):
                ?>
                <tr>
                  <td><?php echo $row['id_latest_events']; ?></td>
                  <td><?php echo $row['title_event']; ?></td>
                  <td><?php echo $row['date_latest_events']; ?> | <?php echo $row['time_latest_events']; ?></td>
                  <td>
                    <a href="./add_latest_events.php?edit_latest_events=<?php echo $row['id_latest_events']; ?>"><i class="material-icons">edit</i></a>
                    /
                    <a href="./add_latest_events.php?delete_latest_events=<?php echo $row['id_latest_events']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
