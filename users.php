        ...
        <ul class="nav">
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./users.php">
                <p>View Users</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Informtions Users :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td><?php echo $row['ID_All_Users']; ?></td>
                  ...
                  <td>
                     <a href="./add_user.php?edit_users=<?php echo $row['ID_All_Users']; ?>"><i class="material-icons">edit</i></a>
                     /
                    <a href="./add_user.php?delete_users=<?php echo $row['ID_All_Users']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
