      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./jobs.php">
                <p>View Jobs</p>
              </a>
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Informations Jobs:</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['title_job']; ?></td>
                    <td><?php echo $row['experience']; ?> - Years</td>
                    <td><img src="Uploded/<?php echo $row['pic_job'] ?>" style="width: 65px; height: 65px;"></td>
                    <td>
                      <a href="./add_jobs.php?edit_jobs=<?php echo $row['id_jobs']; ?>"><i class="material-icons">edit</i></a>
                      /
                      <a href="./add_jobs.php?delete_jobs=<?php echo $row['id_jobs']; ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
