      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./policy_and_privacy.php">
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">View Policies and privacies :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                <tr>
                  <th>Policy and Privacy</th>
                  <th>Edit / Delete</th>
                </tr>
              </tbody>
              <tbody>
                <?php 
                    $select="SELECT * FROM `policy and privacy`";
                    $query=mysqli_query($conn , $select);
                    while($row=mysqli_fetch_assoc($query)):
                  ?>
                  <tr>
                    <td><?php echo $row['policy_and_privacy']; ?></td>
                    <td>
                      <a href="./add_policy_and_privacy.php?edit_policy_and_privacy=<?php echo $row['id_policy_and_privacy']; ?>"><i class="material-icons">edit</i></a>
                      /
                      <a href="./add_policy_and_privacy.php?delete_policy_and_privacy=<?php echo $row['id_policy_and_privacy']; ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
