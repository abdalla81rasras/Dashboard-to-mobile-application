        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_jobs.php">
                <p>Add Jobs</p>
              </a>
              <div class="dropdown-divider"></div>
        ...
        <div class="container-fluid">
          <div class="row pb-3">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <?php if($update==true): ?>
                <h3 class="text-white font-weight-bold">Update Job :</h3>
              <?php else: ?>
                <h3 class="text-white font-weight-bold">Add Job :</h3>
              <?php endif; ?>
            </div> 
          </div>
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                <h5 class="text-white font-weight-bold">Title Job :</h5>
                <input type="text" name="title_job" class="form-control" value="<?php echo htmlspecialchars($title_job); ?>" placeholder="Enter Title ...">
                <div class="text-white"><?php echo $errors['title_job'] ?></div>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                <h5 class="text-white font-weight-bold">Experience :</h5>
                <p class="text-white">
                  <input type="number" name="experience" class="text-primary" value="<?php echo htmlspecialchars($experience); ?>">
                    -  Years 
                </p>
                <div class="text-white"><?php echo $errors['experience'] ?></div>
              </div>
            </div>
            <div class="row mt-5 mb-2">
              <div class="col-lg-5 col-md-5 col-sm-5 col-xl-5">
                <h5 class="text-white font-weight-bold">Upload Picture Job :</h5>
                <input type="file" name="pic_job" class="text-white ">
                <div class="text-white"><?php echo $errors['pic_job'] ?></div> <br>
                <?php if($update==true): ?>
                  <p class="text-white font-weight-bold mr-2 d-inline">Old Picture :  </p>
                  <img src="Uploded/<?php echo $pic_job; ?>" alt="Picture" style="width:100px; height: 100px;">
                <?php endif; ?>
              </div>
            </div> <br><br>
            <div class="row justify-content-around">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
               <?php if($update==true): ?>
                ...
                <?php else: ?>
                  <button name="save_jobs" class="btn btn-primary">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                <button name="cansel_pic_job" class="btn btn-primary">cansel</button>
              </div>
            </div>
          </form>
        </div>
