        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <div class="dropdown-divider"></div>
              <a class="nav-link dropdown-item active1" href="./special_notific.php">
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Special Notifications :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
             <table class="table">
              ...
              <tbody>
                <?php 
                  $select="SELECT * FROM `special notification`";
                  $query=mysqli_query($conn , $select);
                  while($row=mysqli_fetch_assoc($query)):
                ?>
                <tr>
                  <td><?php echo $row['user_id_special_notification']; ?></td>
                  <td><?php echo $row['special_notification']; ?></td>
                  <td>
                    <a href="./add_special_notific.php?edit_special_notification=<?php echo $row['id_special_notification']; ?>"><i class="material-icons">edit</i></a>
                    /
                    <a href="./add_special_notific.php?delete_special_notification=<?php echo $row['id_special_notification']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
              <?php endwhile; ?>
              </tbody>
