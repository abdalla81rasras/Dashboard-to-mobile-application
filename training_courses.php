      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./training_courses.php">
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">Informtions Crouser Training :</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                <?php 
                  $select="SELECT * FROM `crouser training`";
                  $query=mysqli_query($conn , $select);
                  while($row=mysqli_fetch_assoc($query)):
                ?>
                <tr>
                  <td><?php echo $row['id_crouser_training']; ?></td>
                  <td><img src="Uploded/<?php echo $row['pic_crouser_triaining'] ?>" style="width: 65px; height: 65px;"></td>
                  <td><?php echo $row['title_crouser_training']; ?></td>
                  <td><?php echo $row['date_crouser_training']; ?>  <?php echo $row['time_crouser_training']; ?></td>
                  <td><?php echo $row['description_crouser_training']; ?></td>
                  <td><?php echo $row['price_crouser_training']; ?>JOD</td>
                  <td>
                    <a href="./add_training_courses.php?edit_crouser_training=<?php echo $row['id_crouser_training']; ?>"><i class="material-icons">edit</i></a>
                    /
                    <a href="./add_training_courses.php?delete_crouser_training=<?php echo $row['id_crouser_training']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
