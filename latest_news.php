      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              <a class="nav-link dropdown-item active1" href="./latest_news.php">
        ...
        <div class="container-fluid">
          <div class="row d-block">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              <h3 class="text-white font-weight-bold">View Latests news:</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
              ...
              <tbody>
                <?php 
                  $select="SELECT * FROM `latest news`";
                  $query=mysqli_query($conn , $select);
                  while($row=mysqli_fetch_assoc($query)):
                ?>
                <tr>
                  <td><?php echo $row['title_latest_news']; ?></td>
                  <td><?php echo $row['description_latest_news']; ?></td>
                  <td><img src="Uploded/<?php echo $row['pic_latest_news'] ?>" style="width: 65px; height: 65px;"></td>
                  <td>
                    <a href="./add_latest_news.php?edit_latest_news=<?php echo $row['id_latest_news']; ?>"><i class="material-icons">edit</i></a>
                    /
                    <a href="./add_latest_news.php?delete_latest_news=<?php echo $row['id_latest_news']; ?>"><i class="material-icons">delete</i></a>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
