        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown active pb-1">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-0" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="nav-link dropdown-item active1" href="./add_feedback.php">
                <p>Add Feedback</p>
              </a>
            </div>
          </li>
          ...
          <div class="container-fluid">
            <div class="row pb-3">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                <?php if($update==true): ?>
                  <h3 class="text-white font-weight-bold">Update Feedback :</h3>
                <?php else: ?>
                  <h3 class="text-white font-weight-bold">Add Feedback :</h3>
                <?php endif; ?>
              </div> 
            </div>
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                  ...
                  <input type="text" name="id_user_feedback" class="form-control" value="<?php echo htmlspecialchars($id_user_feedback); ?>" placeholder="Enter User ID ...">
                  <div class="text-white"><?php echo $errors['id_user_feedback'] ?></div>
                </div>
              </div>
              <div class="row mt-5 mb-2">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6">
                  <h5 class="text-white font-weight-bold">Feedback :</h5>
                  <textarea name="feedback" cols="30" rows="8" class="form-control" placeholder="Enter Feedback ..."><?php echo htmlspecialchars($feedback); ?></textarea>
                  <div class="text-white"><?php echo $errors['feedback'] ?></div>
                </div>
              </div>
              <br><br>
